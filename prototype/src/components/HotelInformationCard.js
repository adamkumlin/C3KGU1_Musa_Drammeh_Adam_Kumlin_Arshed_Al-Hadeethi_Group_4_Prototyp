...
function HotelInformationCard(props) {
// Komponenten tar emot props.
  ...
  if (!props.chosenHotel === "null" || props.chosenHotel) {
    ...
    return (
      <div className="HotelInformationCard">
        <div key={props.id}>
          ...
          {/* Skapar en div med ett h2-element, ett ul-element, text och en bild. Dessa element fylls med information om hotellen med props. Med hjälp av "props.key" skapas rätt div för rätt hotell.*/}
        </div>
      </div>
    )
  }
...
// Exporterar komponenten som "HotelInformationCard".
